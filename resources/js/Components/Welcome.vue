    ...
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            <div class="mt-6 text-gray-500">
                Help-Desk é um sistema de gerenciamento de chamados destinado a Secretaria de Saúde de Caruaru
            </div>
        </div>
        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">
                        <a href="/estabelecimento">Estabelecimentos</a>
                    </div>
                </div>

                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        Em estabelecimentos, é possível manter o controle de todos os locais de estabelecimento disponíveis pela Secretaria de Saúde de Caruaru.
                    </div>

                    <a href="/estabelecimento">
                        <div class="mt-3 flex items-center text-sm font-semibold text-indigo-700">
                            <div>Explore os estabelecimentos</div>
